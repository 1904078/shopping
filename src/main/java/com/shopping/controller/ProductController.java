...
public class ProductController {
    ...
    @ResponseBody
    public Map<String,Object> getAllProducts(@RequestParam(value = "name",required = false)String name){
        List<Product> productList = new ArrayList<>();
        productList = name ==null || "".equals(name.trim()) ? productService.getAllProduct():productService.getMatchNameProduct(name);
    ...
    public Map<String, Object> productDetail(int id, HttpSession httpSession) {
        ...
        httpSession.setAttribute("productDetailId",String.valueOf(product.getId()));

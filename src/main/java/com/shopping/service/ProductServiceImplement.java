...
public class ProductServiceImplement implements ProductService {
    ...
    public Response deleteProduct(int id) {
        try {
            ...
            return new Response(1, "Delete item succeeded", null);
        }catch (Exception e){
            return new Response(0,"Failed to delete item",null);
        }
    }
    ...
    @Override
    public List<Product> getMatchNameProduct(String name) {
        return productDao.getMatchNameProduct(name);
    }

...
<html lang="zh-CN">
  <head>
    ...
    <title>Myshop search result</title>
		...
		<div class="row margin-t">
			<div class="form-horizontal">
				...
				<div class="form-group form-group-lg col-sm-6 col-md-6">
					<input type="text" class="form-control" id="newSearchKeyWord" placeholder="Java" />
				</div>
				<button class="btn btn-primary btn-lg col-sm-2 col-md-2 big-button" onclick="searchPre()">Find item</button>
			</div>
		</div>
	</div>
	<div class="container">
  ...
  <script type="text/javascript">
	  ...
	  function updateList(searchKeyWord) {
		  ...
		  for(var i=0;i<searchResult.length;i++){
			  var imgURL = "${cp}/img/"+searchResult[i].imgname;

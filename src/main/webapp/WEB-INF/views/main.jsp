...
<html lang="zh-CN">
		...
		<div class="row">
			...
			<div class="col-sm-3 col-md-2 sidebar sidebar-1">
				<ul class="nav nav-sidebar">
					<li class="list-group-item-diy"><a href="#productArea1">Electronics <span class="sr-only">(current)</span></a></li>
					<li class="list-group-item-diy"><a href="#productArea2">Cosmetics</a></li>
					<li class="list-group-item-diy"><a href="#productArea3">Books</a></li>
				</ul>
			</div>
			<!-- 控制内容 -->
				...
				<div class="jumbotron">
					<div class="form-group">
						<div class="col-sm-8"  style="padding-right: 0px;">
							<input id="name" name="name" class="form-control" type="text" style="height: 40px;" placeholder="">
						</div>
						<div class="col-sm-1" style="padding-left: 0px;">
							<button type="submit" class="btn btn-primary" style="height: 40px;" onclick="listProducts()">Search</button>
						</div>
					</div>
				</div>
  ...
  <script type="text/javascript">
      ...
      productType[1] = "Electronics";
      productType[2] = "Cosmetics";
      productType[3] = "Books";
